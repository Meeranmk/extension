...
import UploadedFilesList from "./components/uploadList"
import SearchInput from "./components/searchInput"
import { vscode } from "./vscode" // Adjust path if needed
...
export default function App() {
  ...
  // Notify VS Code extension that the webview is ready
  useEffect(() => {
  ...
  // Accepts optional File parameter for drag-and-drop
